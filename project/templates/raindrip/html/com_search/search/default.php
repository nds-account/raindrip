    ...
    <div class="products-container">
        ...
        if (!empty($products)) {
            foreach ($products as $product) {
                ...
                if ($product->section != "Static Pages" && $product->section != "Uncategorised" && $product->section != "Category" && is_numeric($idProduct) && $idProduct != 87 && $idProduct != 74 && $idProduct != 75 && $idProduct != 94 && $idProduct != 93 /*&& $idProduct <212*/) { // EXCLUDE STSTIC PAGES
                    $imageURL = '';
