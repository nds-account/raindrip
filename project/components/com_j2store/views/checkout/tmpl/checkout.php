...
$(document).on('click', '#button-register', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-register').after('<span class="wait">&nbsp;<img src="media/j2store/images/loading.gif" alt="" /></span>');
		},
		complete: function() {
...
$(document).on('click', '#button-shipping-address', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-shipping-address').after('<span class="wait">&nbsp;<img src="media/j2store/images/loading.gif" alt="" /></span>');
		},
		complete: function() {
