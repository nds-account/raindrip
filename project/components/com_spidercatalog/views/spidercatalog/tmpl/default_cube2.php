...
#productMainDiv1
{
moz-border-top-left-radius: 10px;border-top-left-radius: 10px;-moz-border-top-left-radius: 10px;
margin:15px;
padding:5px;
text-align:left;
overflow:hidden;
...
#productMainDiv2
{
moz-border-top-right-radius: 10px;border-top-right-radius: 10px;-moz-border-top-right-radius: 10px;
margin:15px;
padding:5px;
text-align:left;
overflow:hidden;
...
#productMainDiv3
{
moz-border-bottom-left-radius: 10px;border-bottom-left-radius: 10px;-moz-border-bottom-left-radius: 10px;
margin:15px;
padding:5px;
text-align:left;
overflow:hidden;
...
#productMainDiv4
{
moz-border-bottom-right-radius: 10px;border-bottom-right-radius: 10px;-moz-border-bottom-right-radius: 10px;
margin:15px;
padding:5px;
text-align:left;
overflow:hidden;
...
if(count($rows))
echo '<table cellpadding="0" cellspacing="0" id="productMainTable" style="width:'. ($params->get('count_of_product_in_the_row')*$params->get('product_cell_width')+$params->get('count_of_product_in_the_row')*20).'px"><tr>';
...
$link=$po.$row->id.'/'.$cat_id.'/'.$titlelink;
   ...
   echo '<td><div id="productMainDiv'.$str++.'" style="padding-right: 0px !important;border-width:' . $params->get('border_width') . 'px;border-color:#' . $params->get('border_color') . ';border-style:' . $params->get('border_style') . ';' . (($params->get('text_size_small') != '') ? ('font-size:' . $params->get('text_size_small') . 'px;') : '') . (($params->get('text_color') != '') ? ('color:#' . $params->get('text_color') . ';') : '') . (($params->get('background_color') != '') ? ('background-color:#' . $params->get('background_color') . ';') : '') . ' width:' . $params->get('cell_tumble_all_width') . 'px; height:' . $params->get('cell_tumble_all_height') . 'px;">
...
echo '</tr></tr></table></div>';
   ...
   echo '<td style="width: '.($params->get('cell_tumble_picture_width')+22).'px;vertical-align: top !important;"><img style="height:'.$params->get('cell_tumble_picture_height').'px;width:'.$params->get('cell_tumble_picture_width').'px;background-image:url(components/com_spidercatalog/images/fons.png);background-repeat: no-repeat;background-size:'.($params->get('cell_tumble_picture_width')+22).'px '.($params->get('cell_tumble_picture_height')+22).'px;padding:8px;padding-right: 20px;padding-bottom: 20px;" src="'.JURI::root().'/components/com_spidercatalog/images/noimage.jpg" />
	...
	if($params->get('cell_tumble_picture_height')=='')
				$paramheight=100;
	else
	
				$paramheight=$params->get('cell_tumble_picture_height');
				
	if($params->get('cell_tumble_picture_width')=='')
				$paramwidth=100;
	else
	
				$paramwidth=$params->get('cell_tumble_picture_width');
				
				
        echo '<td style="width: '.($params->get('cell_tumble_picture_width')+22).'px;vertical-align: top !important;"><a href="' . $imgurl[0] . '" target="_blank"><img  style="background-image:url(components/com_spidercatalog/images/fons.png);background-repeat: no-repeat;background-size:'.($params->get('cell_tumble_picture_width')+22).'px '.($params->get('cell_tumble_picture_height')+22).'px;padding:8px;padding-right: 20px;padding-bottom: 20px;width:' . $paramwidth . 'px; height:' . $paramheight . 'px;" src="index.php?option=com_spidercatalog&view=picture&format=raw&tmpl=component&id=' . $row->id . '&picnum=0&width=' . $paramwidth . '&height=' . $paramheight . '" /></a></td>';
		} else{
	if($params->get('cell_tumble_picture_width')>=$params->get('cell_tumble_picture_height'))
	
	 echo '<td style="width: '.($params->get('cell_tumble_picture_width')+22).'px;vertical-align: top !important;"><div style="background-image:url(components/com_spidercatalog/images/fons.png);background-repeat: no-repeat;background-size: 100% 100%;"><a href="' . $imgurl[0] . '" target="_blank"><img style="width:'.$params->get('cell_tumble_picture_width').'px;padding:8px;padding-right: 20px;padding-bottom: 20px;" src="index.php?option=com_spidercatalog&view=picture&format=raw&tmpl=component&id=' . $row->id . '&picnum=0&width=120" /></a></div></td>';
	 else{
	 echo '<td style="width: '.($params->get('cell_tumble_picture_width')+22).'px;vertical-align: top !important;"><div style="background-image:url(components/com_spidercatalog/images/fons.png);background-repeat: no-repeat;background-size: 100% 100%;"><a href="' . $imgurl[0] . '" target="_blank"><img  style="height:'.$params->get('cell_tumble_picture_height').'px;padding:8px;padding-right: 20px;padding-bottom: 20px;" src="index.php?option=com_spidercatalog&view=picture&format=raw&tmpl=component&id=' . $row->id . '&picnum=0&height=' . $params->get('cell_tumble_picture_height'). '" /></a></div></td>';
	}
    }
	}
	...
	echo '<td style="font-size:'.$params->get('cell_tumble_title_size').'pt;"><a style="color:#'.$params->get('cell_tumble_title_font_color').' !important;" href="'.$link.'"><b>'.$row->name.'</b></a><br>';
	if ($params->get('enable_rating'))
      {
        $id = $row->id;
        ...
        if ($voted[$id] == 0)
          {
            ...
            echo "<div id='voting" . $row->id . "' style='height:25px; padding:0px;'>
	...
	echo '<br><div style="background-image:url(components/com_spidercatalog/images/kaperk.png);background-repeat: no-repeat;background-size:'.($params->get('cell_tumble_all_width')-138).'px 32px;padding:8px;color:#'.$params->get('cell_tumble_price_text_color').';font-size:'.$params->get('cell_tumble_price_size').'pt;">' . (($params->get('currency_symbol_position') == 0) ? ($params->get('currency_symbol')) : '') . ' ' . $row->cost . ' ' . (($params->get('currency_symbol_position') == 1) ? $params->get('currency_symbol') : '') . '</div>';
...
echo	'<span style="font-size:'.$params->get('cell_tumble_text_size').'pt;color:#'.$params->get('cell_tumble_text_color').';">'.$description[0].'</span></td></tr><tr>';
