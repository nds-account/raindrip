...
<div class="cart_quickcart">
	...
	<div class="cart_cartstatus">
		...
		<a href="<?php echo $this->current_url . '#rokquickcart';?>"><?php echo JText::_('ROKQUICKCART_YOUR_CART');?>: (<span class="simpleCart_quantity"></span> <?php echo JText::_('ROKQUICKCART_ITEMS');?>
			)</a>
	</div>
				...
				<div class="cart_product_content">
					<div class="cart_padding">
						<div class="cart_product_l">
							...
							<a rel="rokbox" href="<?php echo $item->fullImage;?>"><?php endif; ?>
						...
						<div class="cart_product_r">
							...
							<?php if($item->show_sizes):?>
							<div><?php echo JText::_('ROKQUICKCART_SIZE');?>
							: <?php echo $item->sizes;?></div><?php endif;?>
							<?php if( $item->show_colors):?>
							<div><?php echo JText::_('ROKQUICKCART_COLOR');?>
							: <?php echo $item->colors;?></div><?php endif;?>
							<?php if($this->shipping_per_item):?>
							<div><input class="item_shipping" value="<?php echo $item->shipping;?>" type="hidden">
							</div><?php endif;?>
							<span class="item_thumb"><?php echo $item->cartImage;?></span>

							<div class="cart_product_add">
								<a href="<?php echo $this->current_url . '#rokquickcart';?>" class="item_add"><?php echo JText::_('ROKQUICKCART_ADD_TO_CART');?><span></span></a>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="cart_yourcart">
		...
		<div class="cart_yourcart_items">
			...
			<div class="cart_totals">
				...
				<?php if($this->tax):?>
				<div><?php echo JText::_('ROKQUICKCART_TAX');?>: <span class="simpleCart_taxCost"></span>
				</div><?php endif;?>
				<?php if($this->shipping):?>
				<div><?php echo JText::_('ROKQUICKCART_SHIPPING');?>: <span class="simpleCart_shippingCost"></span>
				</div><?php endif;?>
	...
	<div class="cart_buttons">
		<a href="javascript:;" class="simpleCart_checkout"><?php echo JText::_('ROKQUICKCART_CHECKOUT');?><span></span></a>
		<a href="javascript:;" class="simpleCart_empty"><?php echo JText::_('ROKQUICKCART_EMPTY_CART');?><span></span></a>
	</div>
	<div class="clr"></div>
</div>
