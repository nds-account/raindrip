...
class J2StoreToolBar30 extends JToolbar
{
	...
	protected function renderSubmenu()
	{
		$views = array(
				'cpanel',
				'J2STORE_MAINMENU_SETUP' => array('storeprofiles', 'currencies', 'countries', 'zones', 'geozones', 'taxrates', 'taxprofiles', 'lengths', 'weights', 'shipping', 'payment', 'options', 'coupons', 'emailtemplates', 'fields'),
				'orders',
				'J2STORE_MAINMENU_REPORTS' => array('itemised')
		);
