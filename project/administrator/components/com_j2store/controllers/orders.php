...
class J2StoreControllerOrders extends J2StoreController {
	...
	function view() {
		...
		//get the select list;
		$status_values = array(1 => JText::_('J2STORE_CONFIRMED'), 3 => JText::_('J2STORE_FAILED'), 4 => JText::_('J2STORE_PENDING'));
		$options = array();
	...
	function orderstatesave() {
		...
		// $status_values = array(1 => JText::_('J2STORE_Confirmed'), 3 => JText::_('J2STORE_Failed'), 4 => JText::_('J2STORE_Pending'));
		if($order_state_id == 4) {
			$order_state = JText::_('J2STORE_PENDING');
		} elseif ($order_state_id == 3) {
			$order_state = JText::_('J2STORE_FAILED');
		} elseif ($order_state_id == 1) {
			$order_state = JText::_('J2STORE_CONFIRMED');
		}
