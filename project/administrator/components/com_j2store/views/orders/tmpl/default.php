	...
	<table class="adminlist table table-striped">
		<thead>
			<tr>
				...
				<th class="title"><?php echo JHTML::_('grid.sort',  'J2STORE_ORDER_INVOICE_ID', 'a.id',$this->lists['order_Dir'], $this->lists['order'] ); ?>
				</th>
			...
			<th width="15%">
			 ...
			 -->
				<th width="15%"><?php echo JHTML::_('grid.sort',  'J2STORE_ORDER_ORDER_STATUS', 'a.order_state', $this->lists['order_Dir'], $this->lists['order'] ); ?>
				</th>
			</tr>
		</thead>
		<tfoot>
		...
		<tbody>
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td align="center"><?php if($row->buyer) {
					echo $row->buyer;
				}else {
