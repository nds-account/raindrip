...
/**
 * Methods supporting a list of Ice_video_manager3 records.
 */
class Ice_video_manager3ModelVideos extends JModelList {
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        // Load the parameters.
        $params = JComponentHelper::getParams('com_ice_video_manager3');
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__com_ice_video_manager_vids` AS a');
		...
		$query->select('#__com_ice_video_manager_cats_1305177.name AS categories_name_1305177');
		$query->join('LEFT', '#__com_ice_video_manager_cats AS #__com_ice_video_manager_cats_1305177 ON #__com_ice_video_manager_cats_1305177.id = a.category');
		...
		foreach ($items as $oneItem) {
			...
			if (isset($oneItem->category)) {
				...
				foreach ($values as $value){
					...
					$query
							->select('name')
							->from('`#__com_ice_video_manager_cats`')
