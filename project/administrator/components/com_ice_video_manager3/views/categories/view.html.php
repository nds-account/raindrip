 ...
 */
class Ice_video_manager3ViewCategories extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Ice_video_manager3BackendHelper::addSubmenu('categories');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_ICE_VIDEO_MANAGER3_TITLE_CATEGORIES'), 'categories.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_ice_video_manager3&view=categories');
	...
	protected function getSortFields()
	{
		...
		'a.checked_out' => JText::_('COM_ICE_VIDEO_MANAGER3_CATEGORIES_CHECKED_OUT'),
		'a.checked_out_time' => JText::_('COM_ICE_VIDEO_MANAGER3_CATEGORIES_CHECKED_OUT_TIME'),
		'a.name' => JText::_('COM_ICE_VIDEO_MANAGER3_CATEGORIES_NAME'),
		);
	}
