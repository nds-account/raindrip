...
/**
 * View class for a list of Ice_video_manager3.
 */
class Ice_video_manager3ViewVideos extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Ice_video_manager3BackendHelper::addSubmenu('videos');
	...
	protected function addToolbar()
	{
		...
		$canDo	= Ice_video_manager3BackendHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_ICE_VIDEO_MANAGER3_TITLE_VIDEOS'), 'videos.png');
		...
		if ($canDo->get('core.admin')) {
			JToolBarHelper::preferences('com_ice_video_manager3');
		}
        
        //Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_ice_video_manager3&view=videos');
        ...
        $form = JForm::getInstance('com_ice_video_manager3.video', 'video');
	...
	protected function getSortFields()
	{
		...
		'a.checked_out' => JText::_('COM_ICE_VIDEO_MANAGER3_VIDEOS_CHECKED_OUT'),
		'a.checked_out_time' => JText::_('COM_ICE_VIDEO_MANAGER3_VIDEOS_CHECKED_OUT_TIME'),
		'a.name' => JText::_('COM_ICE_VIDEO_MANAGER3_VIDEOS_NAME'),
		'a.category' => JText::_('COM_ICE_VIDEO_MANAGER3_VIDEOS_CATEGORY'),
		'a.url' => JText::_('COM_ICE_VIDEO_MANAGER3_VIDEOS_URL'),
		);
	}
