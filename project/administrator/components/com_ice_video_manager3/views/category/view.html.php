 ...
 * View to edit
 */
class Ice_video_manager3ViewCategory extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	protected function addToolbar()
	{
		...
		$canDo		= Ice_video_manager3BackendHelper::getActions();

		JToolBarHelper::title(JText::_('COM_ICE_VIDEO_MANAGER3_TITLE_CATEGORY'), 'category.png');
